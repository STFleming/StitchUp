...
\conferenceinfo{DAC '16,}{June 05-09, 2016, Austin, TX, USA}
\isbn{978-1-4503-4236-0/16/06}\acmPrice{\$15.00}
...
\title{StitchUp: Automatic Control Flow Protection\\ for High Level Synthesis Circuits\vspace{-5mm}}
...
%Author Removed for Blind\\
       \affaddr{Electrical and Electronic Engineering Dept, Imperial College London, U.K. \\ \{sf306 | dt10\}@ic.ac.uk}
%       \affaddr{address}
}
...
exhaustive hardware fault injection in each case, finding that all control-flow errors were detected while only requiring
1\% circuit area overhead in the best case.
\end{abstract}
