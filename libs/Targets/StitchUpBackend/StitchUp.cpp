...
extern "C" void LLVMInitializeStitchUpTarget() { 
  RegisterTargetMachine<StitchUpTargetMachine> X(TheStitchUpTarget);
}

char StitchUpPass::ID = 0;
...
bool StitchUpTargetMachine::addPassesToEmitFile(PassManagerBase &PM,
